...
const Portfolio = () => {
  return (
    <div className='min-w-screen min-h-screen relative '>
      <img src={camimg} alt="Camera Group" className="absolute opacity-80 h-[30%] sm:h-[40%] md:h-[50%] lg:h-[55%] xl:h-[60%] left-4 sm:left-10 md:left-20 top-10 sm:top-16 md:top-20 object-contain pointer-events-none" />
